...
function graph.draw(_graph, _, cr, width, height)
    ...
    local base_color = hex2rgb(_graph._private.base_color)
    local blend_color = hex2rgb(_graph._private.blend_color)
        ...
        if #values ~= 0 then
            ...
            for i = 0, #values - 1 do
                ...
                if value >= 0 then
                    ...
                    local c = rgb2hex(rgb_blend(blend_color, base_color, value))
